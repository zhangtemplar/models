...
DATA_DIR="${1%/}"
SCRATCH_DIR="${DATA_DIR}/ILSVRC2015/"
mkdir -p "${DATA_DIR}"
mkdir -p "${SCRATCH_DIR}"
...
TRAIN_DIRECTORY="${SCRATCH_DIR}Data/CLS-LOC/train/"
VALIDATION_DIRECTORY="${SCRATCH_DIR}Data/CLS-LOC/val/"
...
BOUNDING_BOX_DIR="${SCRATCH_DIR}Annotations/CLS-LOC/train"
